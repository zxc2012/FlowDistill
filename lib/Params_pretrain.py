...
def parse_args(device):
    ...
    args.add_argument('--lamb_anneal', type=eval, default=config['train']['lamb_anneal'])
    args.add_argument('--info_loss', type=eval, default=config['train']['info_loss'])
    args.add_argument('-thresh', type=float, default=config['test']['thresh'])
    args.add_argument('--lamb', type=float, default=config['train']['lamb'])
    args.add_argument('--lam', type=float, default=config['train']['lam'])
    args.add_argument('--delta', type=float, default=config['train']['delta'])
    args.add_argument('--distill_loss', type =eval, default = config['train']['distill_loss'])
    args.add_argument('--alpha', type=float, default=config['train']['alpha'])
    args.add_argument('--beta', default=config['train']['beta'], type=float)
    # test
